(() => {
  ...
  function render(){
    ...
    q('#metricIncome').textContent=E.money(result.income);
    q('#metricExpenses').textContent=E.money(result.totalExpense);
    q('#metricMargin').textContent=E.money(result.margin);
